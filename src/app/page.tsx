...
function AlertCard({ alert }: { alert: typeof systemAlerts[0] }) {
  ...
  return (
    <div className={`p-4 rounded-lg border ${isCritical ? 'bg-red-50 border-red-200' : 'bg-amber-50 border-amber-200'}`}>
      <div className="flex items-start gap-3">
        <div className={`mt-0.5 p-1.5 rounded-full ${isCritical ? 'bg-red-100' : 'bg-amber-100'}`}>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-4 mt-3">
            <span className="text-xs text-slate-500">Affected: {alert.affected}</span>
            <div className="flex gap-2 ml-auto">
              ...
              <button className="px-3 py-1 text-xs font-medium text-white bg-slate-700 rounded hover:bg-slate-800 transition-colors">
                View Protocol
              </button>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl p-6 text-white">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h2 className="text-xl font-bold mt-1">E-Passport Portal Integration</h2>
              <p className="text-slate-400 text-sm mt-1">Ministry of Immigration • Sprint 4 of 8 • Deadline: May 15, 2025</p>
            </div>
          </div>
        ...
        <div className="flex flex-wrap gap-3 mt-4 pt-4 border-t border-white/10">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="px-2 py-0.5 bg-blue-500/20 text-blue-300 rounded text-xs">Node.js</span>
            <span className="px-2 py-0.5 bg-green-500/20 text-green-300 rounded text-xs">PostgreSQL</span>
            <span className="px-2 py-0.5 bg-purple-500/20 text-purple-300 rounded text-xs">Redis</span>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            <div className="px-4 py-3 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-slate-800">Critical System Alerts</h3>
              </div>
          ...
          <div className="mt-4 bg-white rounded-xl border border-slate-200 p-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <a href="#" className="flex items-center gap-2 px-3 py-2 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                ...
                <span className="text-sm text-slate-700">Grafana</span>
              </a>
              <a href="#" className="flex items-center gap-2 px-3 py-2 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                <span className="w-2 h-2 bg-blue-400 rounded-full" />
                <span className="text-sm text-slate-700">Datadog</span>
              </a>
              <a href="#" className="flex items-center gap-2 px-3 py-2 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                <span className="w-2 h-2 bg-amber-400 rounded-full" />
                <span className="text-sm text-slate-700">Runbook</span>
              </a>
              <a href="#" className="flex items-center gap-2 px-3 py-2 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                <span className="w-2 h-2 bg-green-400 rounded-full" />
                <span className="text-sm text-slate-700">PagerDuty</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7">
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden h-full">
            <div className="px-4 py-3 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-slate-800">Recent Architecture Updates</h3>
              </div>
              <a href="/knowledge-base" className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                View All
              </a>
            </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      <h4 className="font-medium text-slate-800 hover:text-blue-600 line-clamp-1">
                        {article.title}
                      </h4>
          ...
          <div className="mt-4 bg-white rounded-xl border border-slate-200 p-4">
            ...
            <div className="grid grid-cols-4 gap-2">
              <a href="/issues" className="flex flex-col items-center gap-1 p-3 bg-slate-50 rounded-lg hover:bg-blue-50 hover:border-blue-200 border border-transparent transition-all">
                <svg className="w-5 h-5 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                </svg>
                <span className="text-xs text-slate-600">New Ticket</span>
              </a>
              <a href="/knowledge-base" className="flex flex-col items-center gap-1 p-3 bg-slate-50 rounded-lg hover:bg-blue-50 hover:border-blue-200 border border-transparent transition-all">
                <svg className="w-5 h-5 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                </svg>
                <span className="text-xs text-slate-600">New Doc</span>
              </a>
              <a href="/community" className="flex flex-col items-center gap-1 p-3 bg-slate-50 rounded-lg hover:bg-blue-50 hover:border-blue-200 border border-transparent transition-all">
                <svg className="w-5 h-5 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z" />
                </svg>
                <span className="text-xs text-slate-600">Post</span>
              </a>
              <a href="/learning" className="flex flex-col items-center gap-1 p-3 bg-slate-50 rounded-lg hover:bg-blue-50 hover:border-blue-200 border border-transparent transition-all">
                <svg className="w-5 h-5 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
